			...
			<Image.PreviewGroup>
				<Col span={10}>
					<Col>
						<Image
							width={200}
							height={200}
							src={'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg1.gamersky.com%2Fimage2018%2F05%2F20180522_yxy_415_14%2Fimage015_S.jpg&refer=http%3A%2F%2Fimg1.gamersky.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1680674026&t=cc97053f08e42dff4d5bd6faaf92ba6d'}
						/>
					</Col>
				...
				<Col span={12} pull={4}>
					...
					<Descriptions column={1}>
						<Item label={'卖点信息'}>啊实打实大师大师大师大苏打手打三打哈开机啊合法抗打击沙发哈师大会计法哈卡随机发干哈刷卡机代发哈索拉卡登记</Item>
					</Descriptions>
				</Col>
			</Image.PreviewGroup>
		</Row>
