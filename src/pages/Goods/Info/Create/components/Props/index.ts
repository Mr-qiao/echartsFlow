...
import { ATTR_TYPE } from '../../constant';
...
import {
  default as DateRangeCpt,
  rules as dateRangeRules,
} from './DateRangeCpt';
import { default as FileCpt, rules as fileRules } from './FileCpt';
import { default as ImageCpt, rules as imageRules } from './ImageCpt';
import {
  default as ImageMultipleCpt,
  rules as imageMultipleRules,
} from './ImageMultipleCpt';
import { default as LinkCpt, rules as linkRules } from './LinkCpt';
import { default as NumberCpt, rules as numberRules } from './NumberCpt';
import {
  default as NumberPriceCpt,
  rules as numberPriceRules,
} from './NumberPriceCpt';
import {
  default as NumberRangeCpt,
  rules as numberRangeRules,
} from './NumberRangeCpt';
import {
  default as NumberRateCpt,
  rules as numberRateRules,
} from './NumberRateCpt';
...
export default function renderProps(type: ATTR_TYPE): IProps {
  return {
    ...
    [ATTR_TYPE.NUMBER_PRICE]: {
      Component: NumberPriceCpt,
      rules: numberPriceRules,
    },
    [ATTR_TYPE.NUMBER_RATE]: {
      Component: NumberRateCpt,
      rules: numberRateRules,
    },
    ...
    [ATTR_TYPE.NUMBER_RANGE]: {
      Component: NumberRangeCpt,
      rules: numberRangeRules,
    },
    ...
    [ATTR_TYPE.IMAGE_MULTIPLE]: {
      Component: ImageMultipleCpt,
      rules: imageMultipleRules,
    },
