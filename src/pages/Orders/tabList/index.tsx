...
function TabList(props: any) {
  ...
  const columns: any = [
          ...
          <GoodsTableCol
            ...
            nameArr={[
              ...
              },
              {
                title: '时间',
                key:
                  recode?.sendTime !== null
                    ? moment(recode?.sendTime).format('YYYY-MM-DD HH:mm:ss')
                    : '',
              },
            ]}
          />
    ...
    },
    {
      ...
      search: false,
      render: (_: any, recode: any) => {
        return recode.status === '待发货' && recode.isDeleted !== 1 ? (
          <a
            onClick={() => {
    ...
    <div>
      ...
      >
        <Button
          ...
          style={{ position: 'absolute', right: 80, top: 18 }}
        >
          刷新列表
        </Button>
        <ProTable
