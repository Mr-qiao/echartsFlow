import {Col, Descriptions, Image, InputNumber, Row, Table} from "antd";
			...
			children: [
				{
					...
					render: (_: any, recode: any, index: number) => {
						...
						return (
							<InputNumber min={0} value={recode.sccb} onChange={(e) => {
								console.log(e)
				...
				},
				{
					...
					render: (_: any, recode: any, index: number) => {
						console.log(_, recode, index, 'recode')
						return (
							<InputNumber min={0} value={recode.ppyj} onChange={(e) => {
								console.log(e)
								const NewArr = [...dataSource]
								NewArr[index].ppyj = e
								setDataSource(NewArr)
				...
				},
				{
					...
					render: (_: any, recode: any, index: number) => {
						console.log(_, recode, index, 'recode')
						return (
							<InputNumber min={0} value={recode.ipfy} onChange={(e) => {
								console.log(e)
								const NewArr = [...dataSource]
								NewArr[index].ipfy = e
								setDataSource(NewArr)
				...
				},
				{
					...
					render: (_: any, recode: any, index: number) => {
						console.log(_, recode, index, 'recode')
						return (
							<InputNumber min={0} value={recode.bzcl} onChange={(e) => {
								console.log(e)
								const NewArr = [...dataSource]
								NewArr[index].bzcl = e
								setDataSource(NewArr)
				...
				},
				{
					...
					render: (_: any, recode: any, index: number) => {
						console.log(_, recode, index, 'recode')
						return (
							<InputNumber min={0} value={recode.kdfy} onChange={(e) => {
								console.log(e)
								const NewArr = [...dataSource]
								NewArr[index].kdfy = e
								setDataSource(NewArr)
				...
				<Row>
					...
					<Col span={12}>
						<Descriptions column={2}>
							<DescriptionsItem label={'来源'}>1&nbsp;&nbsp;&nbsp;<a>查看设计</a></DescriptionsItem>
						...
						<Descriptions column={1}>
							<DescriptionsItem
								label={'卖点信息'}>啊实打实大师大师大师大苏打手打三打哈开机啊合法抗打击沙发哈师大会计法哈卡随机发干哈刷卡机代发哈索拉卡登记</DescriptionsItem>
						</Descriptions>
					</Col>
					</Image.PreviewGroup>
				</Row>
